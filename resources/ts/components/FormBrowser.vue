...
const tableOptions: DataTableOptions = {
    ...
    columns: [
        ...
        // The display setting here is to ensure DT only uses the vue slot for display, not for sorting
        {data: 'private', name: 'private', defaultContent: '', render: { display: '#column-private' }},
        {data: 'noMastering', name: 'no-master', defaultContent: '', render: { display: '#column-private' }},
        {data: 'noFunnel', name: 'no-funnel', defaultContent: '', render: { display: '#column-private' }},
        {data: 'noZap', name: 'no-zap', defaultContent: '', render: { display: '#column-private' }},
        {data: 'noNative', name: 'no-native', defaultContent: '', render: { display: '#column-private' }},
        {data: 'noExtract', name: 'no-extract', defaultContent: '', render: { display: '#column-private' }},
        {data: 'noReward', name: 'no-reward', defaultContent: '', render: { display: '#column-private' }},
        {data: 'bypassImmune', name: 'bypass-immunity', defaultContent: '', render: { display: '#column-private' }},
        // Staff Only
